...
const GITHUB_USERNAME = 'dododook'; // 请修改为您的GitHub用户名
...
function detectDevTools() {
    ...
    function showDevToolsMessage() {
        ...
        console.log('%c👋 我的博客：https://vps.128128.best！', 'color: #00b894; font-size: 16px; font-weight: bold;');
        console.log('%c📧 联系我：https://t.me/ron_834', 'color: #fdcb6e; font-size: 14px;');
        console.log('%c🌟 GitHub：https://github.com/dododook', 'color: #e17055; font-size: 14px;');
        ...
        notification.innerHTML = `
            <div class="devtools-content">
                ...
                <div class="devtools-body">
                    <p>👋 你好，开发者朋友！</p>
                    <p>📧 联系：<a href="https://t.me/IonMagic">https://t.me/ron_834</a></p>
